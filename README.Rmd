...
iv. `vegetation` contains the vegetation data recorded at every quadrat in every site
v. `species_list` contains taxonomic and life-history 
...
Lastly, we can make a graph of total pi of different functional groups by sites to get an idea of the variation that exists across different sites in this study. In order to beautify this plot we will need to go through a few extra steps...
